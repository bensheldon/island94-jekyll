...
I was really excited to work on the Mediamap with CCTV because of my long [involvement](http://island94.org/articles/future-cable-access) with Cable Access Television, most notably the now-defunct [DigitalBicycle Project](https://digitalbicycle.org/) and the community maintained directory of Cable Access Stations I built and administer: [MappingAccess.com](http://mappingaccess.com).
